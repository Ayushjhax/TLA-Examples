...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Untitled}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@x{ {\VARIABLES} i ,\, pc}%
\@pvspace{8.0pt}%
\@x{ Init\@s{6.36} \.{\defeq} ( pc \.{=}\@w{start} ) \.{\land} ( i \.{=} 0 )}%
\@pvspace{8.0pt}%
\@x{ Pick\@s{3.05} \.{\defeq} \.{\lor} \.{\land} pc \.{=}\@w{start}}%
\@x{\@s{53.17} \.{\land} i \.{'}\@s{2.87} \.{\in} 0 \.{\dotdot} 1000}%
\@x{\@s{53.17} \.{\land} pc \.{'} \.{=}\@w{middle}}%
\@pvspace{8.0pt}%
\@x{ Add1 \.{\defeq} \.{\lor} \.{\land} pc \.{=}\@w{middle}}%
\@x{\@s{53.17} \.{\land} i \.{'}\@s{2.87} \.{=} i \.{+} 1}%
\@x{\@s{53.17} \.{\land} pc \.{'} \.{=}\@w{done}}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Sep} 28
 01:36:37 \ensuremath{IST} 2025 by \ensuremath{ayush
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Sep} 28 01:32:53
 \ensuremath{IST} 2025 by \ensuremath{ayush
}%
\end{cpar}%
\end{lcom}%
\end{document}
